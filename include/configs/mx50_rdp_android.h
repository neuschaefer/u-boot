...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		...
		"bootargs=console=ttymxc0 init=/init androidboot.console=ttymxc0 keypad video=mxc_elcdif_fb:off calibration \0"
#endif
...
#define CONFIG_ANDROID_RECOVERY_BOOTARGS_MMC \
	"setenv bootargs ${bootargs} init=/init root=/dev/mmcblk0p4 rw rootwait video=mxc_elcdif_fb:off calibration"\
	" rootfs=ext4 keypad"
