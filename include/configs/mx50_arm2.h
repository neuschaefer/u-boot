...
/* 2011/04/06 FY11 : Supported boot image by default. */
#define CONFIG_SPLASH_SCREEN

/*
 * SPLASH SCREEN Configs
 */
/* 2011/04/05 FY11 : Modified address. */
/* 2011/04/05 FY11 : Enabled I2C when splash screen is enabled. */
#ifdef CONFIG_SPLASH_SCREEN
	#define CONFIG_LCD
	#undef LCD_TEST_PATTERN
	#define CONFIG_FB_BASE                          (TEXT_BASE + 0x00400000)
	...
	#define CONFIG_SPLASH_IMG_OFFSET		0x01000000
	#define CONFIG_SPLASH_IMG_SIZE			(800 * 600)
#endif
 ...
 * GPMI Nand Configs
 */
#if 0 /* E_BOOK *//* delete for eMMC boot 2010/12/09 */
...
#define	CONFIG_RAWTABLE_OFFSET		0x00F40000
#define	CONFIG_RAWTABLE_SIZE		(128 * 1024)
...
#ifdef CONFIG_SPLASH_SCREEN
	#define CONFIG_WAVEFORM_FILE_OFFSET		0x01100000
	#define CONFIG_WAVEFORM_FILE_SIZE		0x00200000
	#define CONFIG_WAVEFORM_FILE_IN_MMC

	#define CONFIG_WAVEFORM_BUF_SIZE		CONFIG_WAVEFORM_FILE_SIZE
	#define CONFIG_WORKING_BUF_SIZE			0x00100000
	#define CONFIG_WAVEFORM_BUF_ADDR		(PHYS_SDRAM_1 + PHYS_SDRAM_1_SIZE - 0x00400000)
	#define CONFIG_WORKING_BUF_ADDR			(CONFIG_WAVEFORM_BUF_ADDR - CONFIG_WORKING_BUF_SIZE)
