/*****************************************************************************
*
* Capri-specific clock framework
*
...
#include <asm/arch/brcm_rdb_bmdm_clk_mgr_reg.h>
#include <asm/arch/brcm_rdb_dsp_clk_mgr_reg.h>
...
#include <asm/arch/brcm_rdb_root_clk_mgr_reg.h>
...
DECLARE_REF_CLK      (ref_26m,         26*CLOCK_1M,   6, name_to_clk(ref_156m));
...
DECLARE_CCU_CLK(esub_ccu, 2, ESUB, ESUB,
	78*CLOCK_1M,  156*CLOCK_1M,  156*CLOCK_1M,  156*CLOCK_1M,
	208*CLOCK_1M,  208*CLOCK_1M,  208*CLOCK_1M);

DECLARE_CCU_CLK2(khub_ccu, 6, HUB, KHUB,
	26*CLOCK_1M,  52*CLOCK_1M, 104*CLOCK_1M, 156*CLOCK_1M,
	104*CLOCK_1M, 208*CLOCK_1M, 312*CLOCK_1M);
...
DECLARE_BUS_CLK(audioh_apb, AUDIOH, AUDIOH_APB, khub_ccu, HUB, KHUB,
	...
	26*CLOCK_1M,  26*CLOCK_1M, 26*CLOCK_1M);

/* audioh_156m and audioh_2p4m clocks resample BUS clock, hence declaring as bus clock */
DECLARE_BUS_CLK(audioh_156m, AUDIOH, AUDIOH_156M, khub_ccu, HUB, KHUB,
	156*CLOCK_1M,  156*CLOCK_1M, 156*CLOCK_1M, 156*CLOCK_1M,
	156*CLOCK_1M, 156*CLOCK_1M, 156*CLOCK_1M);

DECLARE_BUS_CLK(audioh_2p4m, AUDIOH, AUDIOH_2P4M, khub_ccu, HUB, KHUB,
	2400*CLOCK_1K,  2400*CLOCK_1K, 2400*CLOCK_1K, 2400*CLOCK_1K,
	2400*CLOCK_1K, 2400*CLOCK_1K, 2400*CLOCK_1K);

DECLARE_BUS_CLK(ssp6_apb, SSP6, SSP6_APB, khub_ccu, HUB, KHUB,
	 26*CLOCK_1M,  26*CLOCK_1M,  26*CLOCK_1M,  26*CLOCK_1M,
...
DECLARE_PERI_CLK_NO_DIV2(audioh_26m, AUDIOH_26M, AUDIOH, crystal, 26*CLOCK_1M, HUB, KHUB);
...
DECLARE_PERI_CLK2(caph_srcmixer, CAPH, CAPH_SRCMIXER, crystal, 26*CLOCK_1M, 1, PERIPH_SEG_TRG, HUB, KHUB, 0);
...
static struct clk *ssp6_audio_clk_src_tbl[] = {
	name_to_clk(crystal),
	name_to_clk(ref_312m),
	name_to_clk(ref_cx40),
};

static struct clk_src ssp6_audio_clk_src = {
	.total          =       ARRAY_SIZE(ssp6_audio_clk_src_tbl),
	.sel            =       2,
	.parents        =       ssp6_audio_clk_src_tbl,
};

DECLARE_PERI_CLK3(ssp6_audio, SSP6, SSP6_AUDIO, ref_cx40, 15360*CLOCK_1K, 10, PERIPH_SEG_TRG, HUB, KHUB, 0);
...
struct clk_lookup capri_clk_tbl[] =
{
	CLK_LK(arm),
...
{
	*clk_tbl = capri_clk_tbl;
	*array_size = ARRAY_SIZE(capri_clk_tbl);
}
