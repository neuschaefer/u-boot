...
static struct pin_config sdio1_config[] = {
    ...
    PIN_CFG(SDIO1_CLK, SDIO1_CLK, 0, OFF, OFF, 0, 1, 8MA),
};
...
static struct pin_config sim2_config[] = {
    PIN_CFG(SIM2_RESETN, SIM2_RESETN, 0, OFF, OFF, 1, 1, 6MA),
    PIN_CFG(SIM2_CLK, SIM2_CLK, 0, OFF, OFF, 1, 1, 8MA),
    PIN_CFG(SIM2_DATA, SIM2_DATA, 0, OFF, OFF, 1, 0, 8MA),
    PIN_CFG(SIM2_DET, SIM2_DET, 1, OFF, ON, 0, 0, 8MA),
};
...
static struct pin_config sdio3_config[] = {
    ...
    PIN_CFG(MPHI_HCE1_N, SDIO3_RST_N, 0, OFF, ON, 0, 1, 12MA),
    PIN_CFG(MPHI_HAT1, SDIO3_CLK, 0, OFF, OFF, 0, 1, 12MA),
...
const struct pin_group pin_config_list[] = {
   ...
   // PIN_GROUP_CFG(PG_SSP4,       ssp4_config,             ARRAY_LEN(ssp4_config) ), // In VC4 development this needs to be assigned to VC jtag.
