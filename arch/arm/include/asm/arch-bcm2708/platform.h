...
#define DMA_BASE                 (BCM2708_PERI_BASE + 0x7000)   /* DMA */
...
#define GP_SET0                 (GPIO_BASE + 0x1C)  /* Set GPIO pin */
#define GP_CLR0                 (GPIO_BASE + 0x28)  /* Clear GPIO pin */
#define GP_LEV0                 (GPIO_BASE + 0x34)  /* GPIO Level */
/*
